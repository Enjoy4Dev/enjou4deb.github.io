...
(function (global, factory) {
    ...
    Plugin.prototype.build = function (index) {
        ...
        _lgUtils2.default.on(_this.outer, 'mousemove.lg click.lg touchstart.lg', function (e) {
    ...
    */
    ...
    Plugin.prototype.closeGallery = function () {
        ...
        var _this = this;
        var mousedown = false;
        _lgUtils2.default.on(this.outer.querySelector('.lg-close'), 'click.lg', function (e) {
            e.stopPropagation();
            _this.destroy();
        });
